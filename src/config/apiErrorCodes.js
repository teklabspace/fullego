 ...
 * This file is canonical since the doc/ reference folder was removed from the
 * repo — any new domain code must be added here in the same PR as the backend
 * change so client and server never drift.
 *
